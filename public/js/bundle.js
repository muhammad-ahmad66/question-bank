...
// ! CREATE COURSE
var fromCreateCourse = document.getElementById("from-create-course");
if (fromCreateCourse) fromCreateCourse.addEventListener("submit", function (e) {
  e.preventDefault();
  ...
  _axios.default.post("/courses", {
    ...
    (0, _alerts.showAlert)("success", "Course created successfully!");
    document.getElementById("from-create-course").reset();
    window.location.assign("/all-courses");
  }).catch(function (error) {
    console.error(error);
    (0, _alerts.showAlert)("error", "Failed to create course!");
  });
});

// ! DELETE COURSE
var deleteCourseBtn = document.querySelectorAll("#btn-delete-course");
if (deleteCourseBtn) deleteCourseBtn.forEach(function (deleteBtn) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            e.preventDefault();
            courseId = deleteBtn.getAttribute("data-course-id");
            console.log(courseId);
            // Send a DELETE request to the API to delete the course
            _context3.next = 6;
            return _axios.default.delete("/courses/".concat(courseId));
          case 6:
            (0, _alerts.showAlert)("success", "Course deleted successfully!");
...
var assignButtons = document.querySelectorAll("#btn-assign-to");
assignButtons.forEach(function (button) {
  button.addEventListener("click", function (event) {
    var courseId = event.target.getAttribute("data-course-id");
    window.location.href = "/all-user?courseId=".concat(courseId);
  });
});

// ! Assigning User to Course
var btnAssignCourse = document.querySelectorAll("#btn-course-assign-all-user");
btnAssignCourse.forEach(function (btn) {
  btn.addEventListener("click", /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(event) {
      var courseId, userId, response;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 5;
            _context4.next = 8;
            return _axios.default.post("/assign-course", {
              userId: userId,
              courseId: courseId
            });
          case 8:
            ...
            if (response.status === 200) {
              (0, _alerts.showAlert)("success", "Course assigned successfully");
          ...
          case 12:
            ...
            console.error("Error assigning course:", _context4.t0);
...
// ! ADD QUESTION
var addQuestionForm = document.getElementById("from-add-question");
if (addQuestionForm) addQuestionForm.addEventListener("submit", /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
    var questionText, courseId, clo, plo, marks, userId, response;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          e.preventDefault();
          questionText = document.getElementById("questionText").value;
          courseId = document.getElementById("courseIdForQuestion").value;
          clo = document.getElementById("clo").value;
          plo = document.getElementById("plo").value; // const difficulty = document.getElementById("difficulty").value;
          marks = document.getElementById("marks").value;
          userId = document.getElementById("btn-create-question").dataset.createdBy;
          _context5.prev = 7;
          _context5.next = 10;
          return _axios.default.post("/questions", {
        ...
        case 10:
          ...
          if (response.status === 201) {
            (0, _alerts.showAlert)("success", "Question added successfully!");
            document.getElementById("from-add-question").reset();
            window.location.reload(); // Refresh the page to reflect the changes
          } else {
            (0, _alerts.showAlert)("error", "Failed to add question!");
          }
          _context5.next = 18;
          break;
        case 14:
          ...
          console.error("Error adding question:", _context5.t0);
...
var btnViewQuestion = document.querySelectorAll("#btn-view-question");
if (btnViewQuestion) btnViewQuestion.forEach(function (btn) {
  btn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.prev = 1;
          _context6.next = 4;
          return _axios.default.get("/questions/course/".concat(courseId, "/questions"));
        case 4:
          ...
          if (response.status === 200) {
            ...
            window.location.href = "/courses/".concat(courseId, "/questions");
        ...
        case 8:
          ...
          console.error("Error fetching questions:", _context6.t0);
        case 11:
        case "end":
...
var noAssessmentsMessage = document.querySelector(".no-assessments-message");
...
function displayAssessments(assessments) {
  ...
  if (assessments.length > 0) {
    ...
    assessments.forEach(function (assessment, index) {
      ...
      row.innerHTML = "\n        <td>".concat(index + 1, "</td>\n        <td>").concat(assessment.assessmentName, "</td>\n        <td>").concat(assessment.type, "</td>\n        <td>").concat(assessment.courseId.courseName, "</td>\n        <td>\n          <button data-assessment-id=").concat(assessment._id, " class=\"view-btn\">View</button>\n          <button class=\"download-btn\">Download</button>\n        </td>\n      ");
...
function fetchAssessments(_x6, _x7) {
  return _fetchAssessments.apply(this, arguments);
}
function _fetchAssessments() {
  _fetchAssessments = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(courseId, type) {
    var response;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          _context8.next = 4;
          return _axios.default.get("/assessments?courseId=".concat(courseId, "&type=").concat(type));
        case 4:
        ...
        case 8:
          ...
          console.error("Error fetching assessments:", _context8.t0);
          noAssessmentsMessage.style.display = "block";
          noAssessmentsMessage.textContent = "An error occurred while fetching assessments.";
        case 13:
        case "end":
...
function handleSelectionChange() {
  return _handleSelectionChange.apply(this, arguments);
}
function _handleSelectionChange() {
  _handleSelectionChange = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
    var courseId, type;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          type = typeSelect.value; // Fetch assessments and handle the response
          _context9.next = 6;
          return fetchAssessments(courseId, type);
        case 6:
          _context9.next = 10;
          break;
        case 8:
        ...
        case 12:
          ...
          console.error("Error during selection change:", _context9.t0);
          assessmentBody.innerHTML = ""; // Clear previous results
          noAssessmentsMessage.style.display = "block";
          noAssessmentsMessage.textContent = "An error occurred while processing your request. Please try again.";
        case 18:
        case "end":
...
document.addEventListener("DOMContentLoaded", function () {
  var courseSelect = document.getElementById("courseId");
  var typeSelect = document.getElementById("type");
  var makeAssessmentBtn = document.getElementById("makeAssessment");
  ...
  function updateButtonHref() {
    ...
    if (courseId && type) {
      makeAssessmentBtn.href = "/assessments/new?courseId=".concat(courseId, "&type=").concat(type);
    } else {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var assessmentFrom = document.getElementById("assessmentForm");
  if (assessmentFrom) assessmentFrom.addEventListener("submit", function (event) {
    var courseId = document.getElementById("hiddenCourseId").value.trim();
    var type = document.getElementById("hiddenType").value.trim();
    var assessmentName = document.getElementById("assessmentName").value.trim();
    ...
    // );
    var selectedQuestions = document.getElementById("questions").value;
  ...
  // ! DOWNLOAD ASSESSMENT
  var downloadAssessment = document.getElementById("downloadButton");
  if (downloadAssessment) downloadAssessment.addEventListener("click", function () {
  ...
  function updateView() {
    ...
    if (viewButtons) viewButtons.forEach(function (btn) {
      btn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        var assessmentId, url;
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              assessmentId = btn.dataset.assessmentId;
              try {
                url = "/assessments/".concat(assessmentId);
